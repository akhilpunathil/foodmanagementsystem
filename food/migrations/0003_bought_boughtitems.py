# Generated by Django 5.0.1 on 2024-08-14 10:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('food', '0002_orderitem_is_order_placed'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bought_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purchaseitems', to='food.bought')),
                ('order_item_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='food.orderitem')),
            ],
        ),
    ]
